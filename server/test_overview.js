...
(async () => {
  try {
    ...
    r = await fetch(`${base}/sessions/01c65d4d-ae87-4eeb-a8e6-2da18b5e044f/overview`, { headers });
    console.log('OVERVIEW_PRE_STATUS', r.status);
    console.log(await r.text());
    r = await fetch(`${base}/sessions/01c65d4d-ae87-4eeb-a8e6-2da18b5e044f/complete`, { method: 'POST', headers });
